...
class Equip extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('uid, cid, position, belong, state, addtime, updatetime', 'numerical', 'integerOnly'=>true),
			array('title, belongs, material, effect', 'length', 'max'=>150),
			array('describe, pic', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, uid, title, cid, position, belong, belongs, material, effect, describe, state, pic, addtime, updatetime', 'safe', 'on'=>'search'),
		);
	}
