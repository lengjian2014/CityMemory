...
class Top extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tuid, addtime, updatetime', 'required'),
			array('tuid, type, pid, puid, addtime, updatetime', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tuid, type, pid, puid, addtime, updatetime', 'safe', 'on'=>'search'),
		);
	}
